...
import { formatCodeWithHindent } from './hindent'
import { formatCodeWithStylishHaskell } from './stylishHaskell'
...
const formatDocumentRange = (cwd: string, log: Logger) => (
    ...
    Future.resolve<string, void>(
        ...
        .chain(() => formatCodeWithHindent(cwd, document.getText(range)))
        .chain(code => formatCodeWithStylishHaskell(cwd, code))
